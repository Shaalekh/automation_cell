...
// LED for command received indicator (active HIGH)
const int commandLED = A3;
...
void setup() {
  ...
  // Set command LED as OUTPUT and turn it off initially
  pinMode(commandLED, OUTPUT);
  digitalWrite(commandLED, LOW);
